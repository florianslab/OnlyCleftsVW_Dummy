...
var zipFiles = {pictures: "http://files.lab.florianschwarz.net/ibexfiles/OnlyCleftVW/Pictures.zip"};

var getCharacterSuitPicture = function(character, suit){
  return c2u.newPicture("", 
                          [{id:"topleftcharacter", background: "url('/"+character+"')", 
                                width: 150, height: 150, left: 75, top: 0}, 
                           {id:"topleftsuit", background: "url('/"+suit+"')", 
